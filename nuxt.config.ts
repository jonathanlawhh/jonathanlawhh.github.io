...
export const routes = [
    ...
    {
        name: 'Travels/Japan Osaka 2023',
        path: '/travels/japan-osaka-23',
        meta: {
            description: 'A small travel diary to the land of sushi and arigatos, Japan',
            image: 'https://jonathanlawhh.com/map/osaka-map.png'
        }
    },
]
